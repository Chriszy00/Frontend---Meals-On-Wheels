        ...
        return (
            <div>
                <div className='row p-0 satoshi'>
                    ...
                    <div className='col-10 px-0 mx-0 my-auto'> {/* FORM */}
                                    ...
                                    <div className="dropdown">
                                        ...
                                        <ul className="dropdown-menu" aria-labelledby="dropdownCategory">
                                            <li><button className="dropdown-item" type='button'
                                                value="Plant Based" onClick={this.categoryChange}>Plant Based</button></li>
                                            <li><button className="dropdown-item" type='button'
                                                value='Meat Based' onClick={this.categoryChange}>Meat Based</button></li>
                                        </ul>
                                    </div>
                                    <div className="dropdown">
                                        <button className="btn btn-secondary bg-secondary-color border-0 dropdown-toggle"
